...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.demo.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.demo.security.DomainUserDetailsService", "createSpringSecurityUser");
