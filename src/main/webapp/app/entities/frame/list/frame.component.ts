...
import { EntityArrayResponseType, FrameService } from '../service/frame.service';
import { FrameDeleteDialogComponent } from '../delete/frame-delete-dialog.component';
...
export class FrameComponent implements OnInit {
  ...
  delete(frame: IFrame): void {
    const modalRef = this.modalService.open(FrameDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.frame = frame;
